...
public class ProjectilePool : MonoBehaviour
{
    ...
    [SerializeField] private int maxPoolSize = 50; // 최대 풀 크기
    [SerializeField] private bool autoExpand = true; // 풀이 부족할 때 자동 확장 여부

    private Queue<GameObject> pool = new Queue<GameObject>(); // 사용 가능한 발사체 큐
    private HashSet<GameObject> activeProjectiles = new HashSet<GameObject>(); // 현재 활성화된 발사체 추적
